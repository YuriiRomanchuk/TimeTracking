...
<tag:page showBar="true" needValidation="true">
    ...
    <form id="form" method="post" action="user-add-request-activity" class="needs-validation" novalidate>
        ...
        <div class="form-group">
            ...
            <label for="requestAction"><fmt:message key="local.user.add.request.activity.action"
                                                     bundle="${messages}"/></label>
            <select name="requestAction" id="requestAction" class="form-control" title="requestAction"
                    required="required">
                <option selected><fmt:message key="local.user.add.request.activity.action.placeholder"
                                              bundle="${messages}"/></option>
                <c:forEach var="requestAction" items="${requestAction}">
                    <option value=${requestAction}>${requestAction} </option>
                    ${requestAction}
                </c:forEach>
            </select>
